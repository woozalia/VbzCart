...
$om = new clsModule(__FILE__, 'mw/vbz-mw-dept.php');
  $om->AddClass('VbzAdminDepts');
$om = new clsModule(__FILE__, 'mw/vbz-mw-image.php');
  $om->AddClass('clsAdminImages');
$om = new clsModule(__FILE__, 'mw/vbz-mw-item.php');
  $om->AddClass('VbzAdminItems');
$om = new clsModule(__FILE__, 'mw/vbz-mw-ship.php');
  $om->AddClass('clsShipments');
$om = new clsModule(__FILE__, 'mw/vbz-mw-supp.php');
  $om->AddClass('VbzAdminSuppliers');
$om = new clsModule(__FILE__, 'mw/vbz-mw-title.php');
  $om->AddClass('VbzAdminTitles');
$om = new clsModule(__FILE__, 'mw/vbz-mw-title-topic.php');
  $om->AddClass('clsAdminTitleTopic_Topics');
$om = new clsModule(__FILE__, 'mw/vbz-mw-topic.php');

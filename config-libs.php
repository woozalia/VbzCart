...
$om = new clsModule(__FILE__, 'cart.php');
  ...
  $om->AddClass('clsShopCart');
$om = new clsModule(__FILE__, 'cart-data.php');
  $om->AddClass('clsCartVars');
$om = new clsModule(__FILE__, 'cart-data-handler.php');
  $om->AddClass('clsPerson_Buyer');
  $om->AddClass('clsPerson_Recip');
  $om->AddClass('clsPayment');
$om = new clsModule(__FILE__, 'cart-display.php');
  $om->AddClass('cCartDisplay');
  $om->AddClass('cCartDisplay_full');
  $om->AddClass('cCartDisplay_full_shop');
  $om->AddClass('cCartDisplay_full_ckout');
  $om->AddClass('cCartDisplay_full_TEXT');
  $om->AddClass('cCartLine_form');
  $om->AddClass('cCartLine_text');
...
$om = new clsModule(__FILE__, 'cust.php');
  $om->AddClass('clsCusts');
$om = new clsModule(__FILE__, 'cust-addr.php');
  $om->AddClass('clsCustAddrs');
$om = new clsModule(__FILE__, 'cust-card.php');
  $om->AddClass('clsCustCards');
  $om->AddClass('clsCustCards_dyn');
$om = new clsModule(__FILE__, 'cust-email.php');
  $om->AddClass('clsCustEmails');
$om = new clsModule(__FILE__, 'cust-name.php');
  $om->AddClass('clsCustNames');
$om = new clsModule(__FILE__, 'cust-phone.php');
  $om->AddClass('clsCustPhones');
$om = new clsModule(__FILE__, 'orders.php');
  $om->AddClass('clsOrders');
$om = new clsModule(__FILE__, 'order-line.php');
  $om->AddClass('clsOrderLines');
$om = new clsModule(__FILE__, 'order-msg.php');
  $om->AddClass('clsOrderMsgs');
...
$om = new clsModule(__FILE__, 'vbz-crypt.php');

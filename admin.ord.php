...
// get fields which might need to be copied, depending on "ship_is" flags:
	...
	$idEmailRecip = $iCart->DataItem(KI_RECIP_EMAIL);
	$idPhoneRecip = $iCart->DataItem(KI_RECIP_PHONE);
	...
	if ($isShiptoSelf) {
	    ...
	    $idEmailBuyer = $iCart->DataItem(KI_BUYER_EMAIL);
	    $idPhoneBuyer = $iCart->DataItem(KI_BUYER_PHONE);

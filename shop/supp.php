...
class vctSuppliers_shop extends vctSuppliers {
    ...
    */
	...
	if ($rc->hasRows()) {
	    ...
	    */
	    $oHdr = new fcSectionHeader('Suppliers');
	    ...
	    $ht .= '<span class=content>There are currently no items available for sale.</span>';
	}
    }
...
__END__;
    ...
    */
	...
	$oHdr = new fcSectionHeader('Departments:');
	$out =

...
abstract class clsCartDataGrp {
    ...
    */
    ...
    /*----
      ...
      PUBLIC so external object can save data copied from one object to another
      USED BY: CartDataRecord::CopyShipToCust()
      HISTORY:
	2014-11-10 Created because Buyer data needed saving after being cloned from Recip.
	2015-08-31 Made this public.
	2016-03-07 This can't possibly work -- FieldValue_forIndex_nz() doesn't write.
    */
	...
	throw new exception('Call GetValue_byName() or SetValue_byName().');
	if (!is_null($sVal)) {
	    $this->arVals[$sName] = $sVal;
	}
	return clsArray::Nz($this->arVals,$sName);
    }
    protected function GetValue_byName($sName,$vDefault) {
	return fcArray::Nz($this->arVals,$sName,$vDefault);
    }
    protected function SetValue_byName($sName,$val) {
	$this->arVals[$sName] = $val;
    }
    /*----
    ...
    */
	...
	$sVal = $this->GetValue_byName($sFld,TRUE);
	return $sVal;
    }
...
*/
    ...
    /*----
      RETURNS or SETS: string to show instead of the stored address
      PUBLIC so Cart object (vcrShopCart) can set it
    */
    private $sReplacesAddress;
    public function ShowForAddress($sVal=NULL) {
	if (!empty($sVal)) {
	    $this->sReplacesAddress = $sVal;
	}
	return $this->sReplacesAddress;
    }
    protected function ShowNormalAddress() {
	return empty($this->sReplacesAddress);
    }
    ...
    */
	...
	throw new exception('2016-07-31 SafeDescr_long() is now in the Records class, not the Table class, as CalcSafeDescr_long().');
    ...
    */
	...
	return strtolower(fcString::ReplaceSequence($s, " \t\n\r", ' '));
    }
    ...
    */
	...
	2016-04-14 This isn't being used in checkout anymore. Is it being used anywhere?
    */
    public function RenderPerson(array $arOptions) {
	throw new exception('2016-04-14 Is this actually being used anymore?');
...
//	}
	...
	$doFixedAll	= clsArray::Nz($arOptions,'do.fixed.all',FALSE);
...
class clsPerson_Buyer extends clsPerson {
    ...
    */
	...
	$arMapAdd = array(
	  ...
	  $arMap = fcArray::Merge($arMapAdd,$arMap);
    ...
    */
	...
	return $this->ValueRecords()->FieldValue_forIndex_nz(KI_CART_PAY_CARD_INTYPE) == KS_FORM_INTYPE_EXISTING;
    }
    /*----
...
class clsPerson_Recip extends clsPerson {
    ...
    */
    ...
    public function DirectionsValue() {
	return $this->ValueRecords()->FieldValue_forIndex_nz(KI_CART_RECIP_MESSAGE);
    }
    ...
    */
    public function UseExisting() {
 	return $this->ValueRecords()->FieldValue_forIndex_nz(KI_CART_RECIP_INTYPE) == KS_FORM_INTYPE_EXISTING;
    }
    /*----

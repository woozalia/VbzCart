...
*/
	    $oSect = new clsWikiSection_std_page($oFmt,$strName);
	      // (array $iarData,$iLinkKey,$iGroupKey=NULL,$iDispOff=NULL,$iDispOn=NULL)
	      $oSect->AddLink_local(new clsWikiSectionLink_option(array(),'edit'));
	      $oSect->AddLink_local(new clsWikiSectionLink_option(array(),'merge','do'));
	    $out = $oSect->Render();
	    ...
	    $oSect = new clsWikiSection_std_page($oFmt,'Orders',3);
	    $out = $oSect->Render();
...
*/
	    ...
	    $oSect = new clsWikiSection_std_page($oFmt,'Mailing',3);
	      // (array $iarData,$iLinkKey,$iGroupKey=NULL,$iDispOff=NULL,$iDispOn=NULL)
	      $oSect->AddLink_local(new clsWikiSectionLink_option(array(),'new-addr','do','new'));
	    $out .= $oSect->Render();
	    $out .= $this->AdminAddrs();
...
/*
	    ...
	    $out .= $objSection->Generate();
*/
	    $oSect = new clsWikiSection_std_page($oFmt,'Email',3);
	      // (array $iarData,$iLinkKey,$iGroupKey=NULL,$iDispOff=NULL,$iDispOn=NULL)
	      $oSect->AddLink_local(new clsWikiSectionLink_option(array(),'new-email','do','new'));
	    $out .= $oSect->Render();
...
/*
	    ...
	    $out .= $objSection->Generate();
*/
	    $oSect = new clsWikiSection_std_page($oFmt,'Phone',3);
	      // (array $iarData,$iLinkKey,$iGroupKey=NULL,$iDispOff=NULL,$iDispOn=NULL)
	      $oSect->AddLink_local(new clsWikiSectionLink_option(array(),'new-phone','do','new'));
	    $out .= $oSect->Render();
...
/*
	    ...
	    $out .= $objSection->Generate();
*/
	    $oSect = new clsWikiSection_std_page($oFmt,'Name',3);
	      // (array $iarData,$iLinkKey,$iGroupKey=NULL,$iDispOff=NULL,$iDispOn=NULL)
	      $oSect->AddLink_local(new clsWikiSectionLink_option(array(),'new-name','do','new'));
	    $out .= $oSect->Render();
	    $out .= $this->AdminNames();
	    $out .= '</td>';
...
/*
	    ...
	    $out = $objSection->Generate();
*/
	    $oSect = new clsWikiSection_std_page($oFmt,'Card',3);
	      // (array $iarData,$iLinkKey,$iGroupKey=NULL,$iDispOff=NULL,$iDispOn=NULL)
	      $oSect->AddLink_local(new clsWikiSectionLink_option(array(),'new-card','do','new'));
	    $out .= $oSect->Render();
	    $out .= $this->AdminCards();
	    $wgOut->AddHTML($out); $out = '';
    ...
    */
	...
	if (is_array($arOrd)) {
		...
		$strNum = $row['Number'];
		$wtNum = SelfLink_WT(array('page'=>KS_PAGE_KEY_ORDER,'id'=>$id),$strNum);
		$strRoles = $row['roles'];
/*
		$strRoles = '';

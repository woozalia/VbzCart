...
*/
class VCA_Suppliers extends clsSuppliers {

    // ++ SETUP ++ //

    public function __construct($iDB) {
	parent::__construct($iDB);
	  $this->ClassSng('VC_Supplier');
    }
    ...
    */
	...
	$rs = $this->GetData();	// get all Supplier table records
	if ($rs->HasRows()) {
	    $out = <<<__END__
<table class=listing>
  <tr>
...
class VC_Supplier extends clsSupplier {
    ...
    */
    ...
    /*----
      CALLED BY: VCA_Suppliers::AdminPage()
      HISTORY:
    ...
    */
    ...
    /* 2014-03-22 disabled until I figure out what the "show" param was for
    ...
    */
	...
	$htManage = $this->AdminLink('manage');
	$htWikiPub = $this->PublicWikiLink('public');
	$htWikiPvt = $this->AdminWikiLink('private');
	$wtActions = "[$htShop][$htManage] info:[$htWikiPub][$htWikiPvt]";

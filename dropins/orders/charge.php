...
*/
// order charges
class VCT_OrderChgs extends clsTable {
    const TableName='cust_charges';

    public function __construct($iDB) {
	parent::__construct($iDB);
	  $this->ClassSng('VCR_OrderChg');	// override parent
...
class VCR_OrderChg extends clsDataSet {
...
__END__;
	...
	$htOrd = $objOrd->AdminLink_name();
	$htCard = $objCard->AdminLink($objCard->ShortNumExpName());
	$out .= <<<__END__
<table>
  <tr>

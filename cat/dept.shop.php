...
class vctDepts_shop extends clsDepts {
...
class vcrDept_shop extends clsDept {
    ...
    */
	...
	if (($cntAct + $cntRet) == 0) {
	    ...
	    if ($cntAct > 0) {
		$ht .= $oPage->RenderSectionHeader('&darr; Available Titles')
	    ...
	    if ($cntRet > 0) {
		//$ht .= $oPage->RenderSectionHeader('&darr; Retired Titles')
		$ht .= $oPage->RenderSectionHeader('<img src=/tools/img/icons/arr1-r.gif> Retired Titles')
		  .$arRes['ret'];
	    }
	}
	return $ht;

...
//    use ftLoggableRecord;	// 2017-01-16 why is this needed?
	...
	return $this->Link().$this->NameString().'</a>';
    }
	...
	if (!$isForSale) {
	    $out .= KHTML_TITLE_EXISTS_NO_ITEMS;
	}
...
/*	} else {
    ...
    */
    public function RenderImages_forRows($sPopup,$sSize=clsImages::SIZE_THUMB) {
	//throw new exception('Who calls this?'); // It should probably be moved to vcqrTitleInfo.

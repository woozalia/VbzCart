...
*/
class vctFolders extends vcShopTable {
    ...
    */
	...
	throw new exception('vctFolders::DropDown() -- who calls this?');
...
class vcrFolder extends vcBasicRecordset {
	...
	$out = '';
	/* 2017-07-29 ID_Parent no longer in use
	if ($this->HasParent()) {

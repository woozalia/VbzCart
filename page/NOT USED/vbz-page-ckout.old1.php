...
*/
class clsPageCkout extends vcPageAdmin {
    private $arMissing;
    ...
    // TODO: these methods should not be required unless there is a menu... or should the sidebar be the menu?
    ...
    */
	...
	$sValPhone = $rcCartData->BuyerPhoneNumber_entered(FALSE);
...
# which page were we just on
    ...
    /*
      RETURNS: HTML, presumably for display
